    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto relative">
                ...
                {/* card */}
                <div className="relative rounded-tl-3xl rounded-bl-3xl rounded-tr-3xl bg-[#f3ece4] dark:bg-[#2c2b26] shadow-xl dark:shadow-black/40 px-5 sm:px-8 md:px-14 pt-5 pb-10 sm:pb-14 transition-colors duration-300">
                    ...
                    >
                        ...
                        <div className="bg-[#a9bcbc]/70 dark:bg-[#3d4a4b] backdrop-blur-sm px-4 py-2 sm:px-6 sm:py-2.5 md:px-8 md:py-3 shadow-lg">
                            <h2 className="font-display text-3xl sm:text-4xl md:text-6xl font-bold tracking-wide text-[#1f2a2a] dark:text-[#ece6da] whitespace-nowrap">
                                Experience
                            </h2>
                        </div>
                    </div>
                    ...
                    {/* content */}
                    <div className="mt-14 sm:mt-10 lg:mt-6 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] gap-8 sm:gap-10 lg:gap-14 items-start">

                        {/* left side*/}
                        {experienceData.map((exp, idx) => (
                            <div key={idx} className="flex gap-3 sm:gap-4 mt-2 sm:mt-8 lg:mt-15">
                                <span className="font-display italic font-bold text-xl sm:text-2xl pr-2 sm:pr-3 text-black dark:text-[#ece6da] shrink-0">
                                    {exp.year}
                                </span>

                                <div className="pt-1">
                                    <span className="inline-block w-2 h-2 rounded-full bg-[#928366] dark:bg-[#c9b98f] -ml-4 mr-2 align-middle" />
                                    <h3 className="inline text-sm sm:text-base font-extrabold uppercase tracking-wide text-black dark:text-white">
                                        {exp.role}
                                        <br />
                                        {exp.org}
                                    </h3>
                                    ...
                                    <ul className="mt-4 space-y-3">
                                        {exp.bullets.map((b, i) => (
                                            <li key={i} className="flex gap-3 text-sm sm:text-base text-black dark:text-[#e5e5e5] leading-relaxed">
                        ...
                        <div>
                            ...
                            <div className="mt-4 flex items-center justify-center gap-2 text-center">
                                <a
                                    ...
                                    className="text-sm sm:text-base font-semibold text-[#2f5fd6] dark:text-[#8fb4ff] underline underline-offset-4"
                                >
                                    PMA Admission Design
                                </a>
                                <MousePointer2 className="w-5 h-5 sm:w-6 sm:h-6 text-black fill-black dark:text-[white] shrink-0" strokeWidth={1.5} />
                            </div>
                        </div>
                    </div>
